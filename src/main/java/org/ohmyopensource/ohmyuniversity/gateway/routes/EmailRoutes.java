 ...
 * core service and rewritten to the internal path structure {@code /api/v1/email/**}.
 *
 * <p>Authentication and authorization are enforced by the gateway
 * security chain. The OAuth2 callback endpoint remains publicly accessible because it is invoked
 * directly by Microsoft's authorization servers after user consent.
 *
 * <p>Exposed routes:
 * <ul>
 *   <li>GET    /v1/email/auth/url - Generates the OAuth2 authorization URL.</li>
 *   <li>GET    /v1/email/auth/callback - Handles the OAuth2 authorization callback.</li>
 *   <li>DELETE /v1/email/auth/disconnect - Disconnects the linked email account.</li>
 *   <li>GET    /v1/email/inbox - Retrieves inbox messages.</li>
 *   <li>GET    /v1/email/{messageId} - Retrieves a specific email message.</li>
 *   <li>POST   /v1/email/send - Sends a new email message.</li>
 * </ul>
 *
...
public class EmailRoutes {
   ...
   * to the core service after rewriting the path prefix from {@code /v1} to {@code /api/v1}.
   *
